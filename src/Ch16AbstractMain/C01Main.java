...
//상속관계의 하위클래스는 미완성된 함수(추상메서드)를 반드시 재정의 해야 객체생성이 가능하다
//일반적으로 추상클래스는 참조변수로서 Upcasting용으로 사용된다
...
public class C01Main {
	...
	public static void main(String[] args) {
		...
		//추상클래스
//		Par2 ob3 = new Par2();	//상위클래스로 객체 생성불가능(추상메서드를 포함하고 있기 때문에)
		Par2 ob3 = null;
		Son2 ob4 = new Son2();	//하위클래스로 객체 생성가능(단 추상메서드 강제 재정의 해야 가능)
